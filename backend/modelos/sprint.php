...
class Sprint {
        ...
        public function consulta(){
            $con = "SELECT * FROM sprint ORDER BY nombre";
        ...
        public function eliminar ($el){
            $del = "DELETE FROM sprint WHERE id_sprint = $el";
            mysqli_query( $this->conexion, $del);
            $vec =[];
            $vec ['resultado'] = "OK";
            $vec ['mensaje'] = "El sprint ha sido elimimnado";
            return $vec;
        }

        public function insertar ($params){
            $ins = "INSERT INTO sprint(nombre, fo_id_proyecto) VALUES ('$params-> nombre', $params-> id_proyecto)";
